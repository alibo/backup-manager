...
class DeleteOldFilesProcedureSpec extends ObjectBehavior
{
    function it_is_initializable(
        ...
        {
            $this->beConstructedWith($filesystemProvider, $databaseProvider, $compressorProvider, $shellProcessor,
                $sequence);
            $this->shouldHaveType('BackupManager\Procedures\DeleteOldFilesProcedure');
        }
    }
}
